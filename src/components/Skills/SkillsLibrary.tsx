  ...
  return (
    <LazyMotion features={domAnimation}>
      <div className="flex w-full justify-between items-center">
        <span className="w-56 mb-10 relative px-6 py-2 text-center font-light bg-[#9E9FA5] rounded-3xl shadow-lg border-2 border-[#FFF6E0] text-grayscale-50">
          #FRONT-END-SKILLS
        </span>
      ...
      <div className="flex w-full justify-between items-center">
        <span className="w-56 relative px-6 py-2 text-center font-light bg-[#9E9FA5] rounded-3xl shadow-lg border-2 border-[#FFF6E0] text-grayscale-50">
          #USING TOOLS
        </span>
