...
const SkillsLibrary = () => {
  ...
  return (
    <LazyMotion features={domAnimation}>
      <div className="flex w-full justify-between items-center mb-44 sm:mb-0 ">
        <m.span
          initial={{ opacity: 0 }}
        ...
        <ul className="flex h-20 w-full justify-center items-center flex-wrap md:flex-nowrap ">
          {frontSkills.map((frontSkill) => (
            <m.li
              ...
              className="relative w-14 h-14 flex m-2 justify-center flex-col sm:flex-row items-center cursor-pointer group border-2 border-[#FFF6E0] bg-[#FFBFBF] rounded-md"
            >
      ...
      <div className="flex w-full justify-between items-center mt-24 md:mt-10">
        <m.span
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}
          transition={{ duration: 1, type: "spring" }}
          className="w-56 relative px-6 py-2 text-center font-light bg-[#9E9FA5] rounded-3xl shadow-lg border-2 border-[#FFF6E0] text-grayscale-50 mr-0 sm:mr-10"
        >
          #USING TOOLS
        </m.span>
        <ul className="flex h-20 w-full justify-center items-center flex-wrap">
